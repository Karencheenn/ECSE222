...
entity Karen_Chen_rca_behavioral_tb is
--empty
end Karen_Chen_rca_behavioral_tb;

-- Testbench for the half-adder
architecture tb of Karen_Chen_rca_behavioral_tb is
	component Karen_Chen_rca_behavioral
		port(
