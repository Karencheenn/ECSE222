...
entity Karen_Chen_rca_structural is
	port(
		A, B: in std_logic_vector (3 downto 0);
		S: out std_logic_vector (4 downto 0)
	);
end Karen_Chen_rca_structural;

architecture rca_struct of Karen_Chen_rca_structural is
...
begin
	...
	FA1: Karen_Chen_full_adder
		port map(A(0), B(0), '0', S(0), c_FA1);
		 -- c_in of FA1 is '0'
	
	FA2: Karen_Chen_full_adder
		port map(A(1), B(1), c_FA1, S(1), c_FA2);
		
	FA3: Karen_Chen_full_adder
		port map(A(2), B(2), c_FA2, S(2), c_FA3);
		
	FA4: Karen_Chen_full_adder
