...
entity Karen_Chen_bcd_adder_structural is
	port(
		A, B: in std_logic_vector (3 downto 0);
		S: out std_logic_vector (3 downto 0);
		C: out std_logic
	);
end Karen_Chen_bcd_adder_structural;

architecture bcd_struct of Karen_Chen_bcd_adder_structural is
	component Karen_Chen_rca_structural
		port(
		A, B: in std_logic_vector (3 downto 0);
...
begin
	...
	-- Z => S of RCA
	-- (A, B, Z)
	RCA1: Karen_Chen_rca_structural
		port map(A, B, Z);
	...
	HA: Karen_Chen_Half_Adder -- map(a,b,s,c)
		port map(C_temp, Z(1), S(1), HA_c);
	
	FA: Karen_Chen_Full_Adder -- map(a, b, c_in, s, c_out)
